...
/**
 * Manages the database that stores the Calorie table and its entitites.
...
abstract class CalorieDatabase: RoomDatabase() {
    ...
    companion object {
        ...
        @Volatile
        private var INSTANCE: CalorieDatabase? = null // This class
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(
                        ...
                        CalorieDatabase::class.java, // Your database class
                        "calorie_database"
                    )
